...
function Services() {
  return (
    <div className="container mx-auto">
      <h1 className="text-center mt-5 text-3xl">Services</h1>
      <div className="h-full w-full pt-12 p-4">
        <div className="grid gap-14 md:grid-cols-3 lg:grid-cols-4 md:gap-5">
          <div className="rounded-xl bg-white p-6 text-center shadow-xl">
            ...
            <p className="px-4 text-gray-500">
              One needs silence to read books or to study, our library has
              special arrangements for the silence zone.
            </p>
          </div>
          <div
            data-aos-delay="150"
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Apart from reading inside the library, we also provide facility to
              rent and return the books in time.
            </p>
          </div>
          <div
            data-aos-delay="300"
          ...
          >
            ...
            <p className="px-4 text-gray-500">
              Modern infrastructure, air-conditioned, sound proof,
              state-of-the-art classrooms that foster leaming.
            </p>
          </div>
          <div
            data-aos-delay="300"
          ...
          >
            ...
            <h1 className="text-darken mb-3 pt-3 text-xl font-medium lg:h-14 lg:px-14">
              Categorized Book Collection{" "}
            </h1>
            <p className="px-4 text-gray-500">
              We have excellent collection of books categorized under children,
              fiction, cookbooks etc for easy access.
            </p>
          </div>
        </div>
      </div>
